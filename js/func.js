window.onload = function() {
	...
	function ClickFrontShow() {
		//定义所需文字和颜色
		this.fron = ['C#', 'Java', 'Html', 'GoLang', 'Php', 'JavaScript', 'C++', 'Basic', 'Css', 'Python','.Net'];
		this.colo = ['#FF69B4', '#ff6651', 'orange', '#FF00FF', '#00FF7F', '#00BFFF', '#BA55D3'];
		//获取body元素
		this.elBody = document.querySelector(".letterTop");
		//初始化randomNum
		this.randomNum = null;
		//初始化字体inde
		this.finde = 0;
	...
	ClickFrontShow.prototype.listenMouse = function() {
		...
		//鼠标点击事件
		document.querySelector('.letterTop').onclick = function(e) {
